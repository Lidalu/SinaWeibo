...
public enum LLu_AlignType {
    ...
    private func layoutAttributes(isInner: Bool, isVertical: Bool) -> LLu_LayoutAttributes {
        let attributes = LLu_LayoutAttributes()
        ...
        switch self {
            ...
            // 仅内部参照需要
            case .Center:
                return LLu_LayoutAttributes(horizontal: .CenterX, referHorizontal: .CenterX, vertical: .CenterY, referVertical: .CenterY)
        }
    }
}
...
extension UIView {
    ...
    :returns: 约束数组
    */
    public func llu_Fill(referView: UIView, insets: UIEdgeInsets = UIEdgeInsetsZero) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    public func llu_AlignInner(type type: LLu_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPointZero) -> [NSLayoutConstraint]  {
        
        return llu_AlignLayout(referView, attributes: type.layoutAttributes(true, isVertical: true), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
    public func llu_AlignVertical(type type: LLu_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPointZero) -> [NSLayoutConstraint] {
        
        return llu_AlignLayout(referView, attributes: type.layoutAttributes(false, isVertical: true), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
    public func llu_AlignHorizontal(type type: LLu_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPointZero) -> [NSLayoutConstraint] {
        
        return llu_AlignLayout(referView, attributes: type.layoutAttributes(false, isVertical: false), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
    public func llu_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        firstView.llu_AlignInner(type: LLu_AlignType.TopLeft, referView: self, size: nil, offset: CGPoint(x: insets.left, y: insets.top))
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.llu_sizeConstraints(firstView)
            subView.llu_AlignHorizontal(type: LLu_AlignType.TopRight, referView: preView, size: nil, offset: CGPoint(x: insets.right, y: 0))
            preView = subView
        }
    ...
    :returns: 约束数组
    */
    public func llu_VerticalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.llu_sizeConstraints(firstView)
            subView.llu_AlignVertical(type: LLu_AlignType.BottomLeft, referView: preView, size: nil, offset: CGPoint(x: 0, y: insets.bottom))
            preView = subView
        }
    ...
    :returns: 对应的约束
    */
    public func llu_Constraint(constraintsList: [NSLayoutConstraint], attribute: NSLayoutAttribute) -> NSLayoutConstraint? {
    ...
    :returns: 约束数组
    */
    private func llu_AlignLayout(referView: UIView, attributes: LLu_LayoutAttributes, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
        
        translatesAutoresizingMaskIntoConstraints = false
        
        var cons = [NSLayoutConstraint]()
        
        cons += llu_positionConstraints(referView, attributes: attributes, offset: offset)
        
        if size != nil {
            cons += llu_sizeConstraints(size!)
        }
    ...
    :returns: 约束数组
    */
    private func llu_sizeConstraints(size: CGSize) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    private func llu_sizeConstraints(referView: UIView) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    private func llu_positionConstraints(referView: UIView, attributes: LLu_LayoutAttributes, offset: CGPoint) -> [NSLayoutConstraint] {
...
///  布局属性
private final class LLu_LayoutAttributes {
